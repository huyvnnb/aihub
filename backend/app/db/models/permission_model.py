...
class RolePermission(SQLModel, table=True):
    ...
    role_id: UUID = Field(foreign_key="roles.id", primary_key=True, nullable=False)
    permission_id: UUID = Field(foreign_key="permissions.id", primary_key=True, nullable=False)
